...
auth_channel = environ.get('AUTH_CHANNEL', '-1001810967351') # give your force subscribe channel id here else leave it blank
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'newvodi')
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://app.koyeb.com/services/f6c4e400-d50d-4627-88d2-e868a05550ed?deploymentId=67559c22-926e-4f7a-8b34-443ec6617c4e")
